...
todoRouter.get("/get-my-todo/:userId",async(req,res)=>{
    const {userId}=req.params;   //jo route me liya wo hi lenge agr route me user_Id lete to yaha bhi user_id hi lete
...
todoRouter.put("/update-todo/:todoId",async(req,res)=>{
    const {todoId}=req.params;   //jo route me liya wo hi lenge agr route me user_Id lete to yaha bhi user_id hi lete
